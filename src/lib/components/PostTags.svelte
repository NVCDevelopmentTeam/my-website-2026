      ...
      {#each tags as tag (tag.slug)}
        <li>
          <a
            ...
            class="px-3 py-1 bg-purple-50 dark:bg-purple-950/30 text-purple-900 dark:text-purple-300 rounded-full border border-purple-200 dark:border-purple-800 hover:bg-purple-100 dark:hover:bg-purple-900/50 transition-colors font-bold"
          >
            {tag.title}
          </a>
        </li>
...
{:else}
  <p class="text-sm text-gray-950 dark:text-gray-50 italic">Chưa có thẻ</p>
{/if}
