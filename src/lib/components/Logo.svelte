...
<div class="m-0 text-base font-bold -tracking-[0.5px] leading-tight">
  ...
  >
    <!-- 
		...
		-->
    <div
      class="w-9 h-9 rounded-full shadow-md transition-[transform,shadow] duration-500 hover:scale-110 object-cover flex-shrink-0 overflow-hidden bg-gradient-to-br from-amber-200 to-orange-300"
    >
      <svg
