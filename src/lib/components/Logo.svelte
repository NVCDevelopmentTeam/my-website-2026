...
<p class="m-0 text-base font-bold -tracking-[0.5px] leading-tight">
	<a
		href={homeHref}
		class="flex items-center gap-2 font-bold text-lg text-gray-950 dark:text-white hover:text-sky-800 dark:hover:text-sky-400 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-sky-800 dark:focus:ring-sky-400 rounded-full p-1"
