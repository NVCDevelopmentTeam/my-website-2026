...
<div class="container mx-auto px-4 py-16">
	<div class="max-w-3xl mx-auto">
		...
		<h1 class="text-4xl font-black text-center mb-10 text-gray-950 dark:text-gray-50">
			Tất cả thẻ 
			            <span class="text-gray-950 dark:text-gray-50 text-2xl">				({totalTags || 0})
			</span>
		</h1>
			...
			<div class="flex flex-wrap gap-3 justify-center">
				{#each tags as tag (tag.slug)}
					...
					>
						...
						<span class="text-xs text-purple-950 dark:text-purple-50 bg-purple-200 dark:bg-purple-900/60 px-2 py-0.5 rounded-full font-black">
							{tag.count}
						</span>
					</a>
				{/each}
