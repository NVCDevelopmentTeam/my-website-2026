...
type LayoutRouteId = RouteId | "/(app)" | "/(app)/blog" | "/(app)/blog/category" | "/(app)/blog/category/[category]" | "/(app)/blog/tag" | "/(app)/blog/tag/[tag]" | "/(app)/blog/[post]" | "/(app)/contact" | "/(app)/[page]" | "/admin" | null
type LayoutParams = RouteParams & { category?: string; tag?: string; post?: string; page?: string }
